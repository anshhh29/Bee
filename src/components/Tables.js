                                    ...
                                    <div>
                                        ...
                                        <div className="mt-3 text-center sm:mt-5">
                                            ...
                                            <div className="mt-2 space-y-3">
                                               ...
                                               <input value={phone} onChange={(e) => setPhone(e.target.value)} className='border border-gray-200 outline-none px-5 py-2 text-sm' type="number" name="" id="" placeholder='Phone'/>
